...
Az árumennyiség növekedése megkövetelte a közlekedés fejlesz- tését. Csatornák, utak és vashidak épültek Angliában majd Európá- ban is, és elterjedt a simább és ellenállóbb útfelületet eredményező zúzott kövekből készült makadámút. A gőz hajtóerejét a közlekedés- ben is igyekeztek kihasználni. Mivel az ipari forradalom előtt csak vízi úton lehetett olcsón nagy tömegű árut szállítani, az amerikai Fulton a gőzhajót épített. A szárazföldi közlekedésben a vasút hozta meg az igazi áttörést. George Stephenson gőzmozdonya 1825-től közlekedett a szabványosított, azonos nyomtávú síneken.  Az iparo-
...
A kohászati, elektronikai és vegyipari találmányok jelentősen át- alakították a városokat. A milliós lélekszámú Londonban, Párizs- ban, Berlinben, Bécsben és Budapesten kiépítették a közvilágítást, amely előbb gázzal, később elektromossággal működött. A nagyvá- rosokban elterjedt az autó, megjelentek a modern tömegközleke- dési eszközök: a villamos, majd az autóbusz is. Látványos gyor- sasággal épültek a tömegek befogadására alkalmas acélszerkezetes építmények: hidak, vásárcsarnokok, pályaudvarok.

A nehézipar a könnyűipari üzemekhez képest sokkal nagyobb tőkebefektetést igényelt. A vállalkozások közötti szabad verseny végül tőkekoncentrációhoz és óriásvállalatok, monopóliumok ki- alakulásához vezetett. A tőkeösszevonással a kisebb vállalatok megszűntek vagy beolvadtak a nagyokba. Kartellek, szindikátusok, konszernek és trösztök jöttek létre, amelyek már korlátozták a ver- senyt, és uralták - monopolizálták – a termelést és a piacot.

!!@@Vázlat röviden:@@
1. ipari forradalom (18.sz végétől 19.sz közepéig)
...
Ipari központok: Manchester, Liverpool, 
gyerekmunka alkalmazása 

Az első ipari forradalomhoz kapcsolódó további jellemzők:

&&Manufaktúrák helyett gyárak Az ipari termelés korábban a manufaktúrákban, kézi munkával történt. Az ipari forradalom idején azonban gépek által vezérelt gyárak alakultak ki, amelyek hatékonyabban és nagyobb mennyiségben tudtak termelni.&&
  
&&Feudális rendszer felbomlása: Az ipari forradalom hozzájárult a feudális rendszer összeomlásához. A korábbi rendszerben a társadalom hierarchikusan szerveződött, a földbirtokosok és jobbágyok közötti viszony alakította meg a gazdasági és társadalmi struktúrát. Az ipari forradalom azonban új gazdasági erők megjelenésével hozzájárult a feudális rendszer felbomlásához, és a polgári társadalom kialakulásához vezetett.&&

&&Munkásosztály kialakulása: Az ipari forradalom során jelentős mennyiségű munkaerőre volt szükség a gyárakban és az ipari létesítményekben. Ennek eredményeként nagyszámú munkásosztály alakult ki, akik általában alacsony fizetésért és rossz munkakörülmények között dolgoztak. &&

&&Gyermekmunka alkalmazása: Az ipari forradalom kezdeti szakaszában gyakran alkalmaztak gyermekmunkaerőt is a gyárakban és a textiliparban. A gyerekek alacsonyabb bérért dolgoztak, és gyakran veszélyes körülmények között végezték a munkát. Ez később társadalmi ellenállást váltott ki és a munkásjogi reformokat sürgette. &&


##II.Ipari forradalom (1871(nagynémetország létrejötte). 1914(1. vh kezdete))##

##Fő központok##: USA, Németország

##Gyártástechnológia##:

- Futószalag (Fort Tmodell)
- Óriásüzemek (Több ezer embert foglalkoztattak, Pl: GeneralMotors(usa), Krupp muvek(nemet))
- Monopóliumok (Nagy tőkeigény miatt jött létre, jelentés: Egy terméket csak egy vállalat gyárt)
- Banktőke (Rockefeller család)
- Tőzsde megjelenik (Nagy tőkeigény miatt a köznéptől szedték be a pénzt a vállalat inditáshoz)
...
- Jelentős technológiai fejlődés: Otto motor, repülőgépek, telefon, dinamit, léghajó stb.
